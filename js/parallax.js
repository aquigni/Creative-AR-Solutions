		...
		if(has_touch || screen.width <= 699) {
		  ...
		  el.mouseenter(function(e) {
			...
			el.find("> .ibg-bg").css({
			  ...
			  "-webkit-transition": "-webkit-transform " + settings.animationSpeed + " ease-in-out",
			  "-moz-transition": "-moz-transform " + settings.animationSpeed + " ease-in-out",
			  "-o-transition": "-o-transform " + settings.animationSpeed + " ease-in-out",
			  "transition": "transform " + settings.animationSpeed + " ease-in-out"
